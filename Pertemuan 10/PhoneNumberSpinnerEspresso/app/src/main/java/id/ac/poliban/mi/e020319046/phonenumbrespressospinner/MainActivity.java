package id.ac.poliban.mi.e020319046.phonenumbrespressospinner;
...
public class MainActivity extends AppCompatActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Phone Number Spinner Espresso Syahid");
