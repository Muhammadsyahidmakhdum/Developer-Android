package id.ac.poliban.mi.e020319046.roomwordssamplehomework;
...
public class MainActivity extends AppCompatActivity {
    ...
    private String sharedPrefFile = "id.ac.poliban.mi.e020319046.roomwordssamplehomework";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("Data Storage Types Syahid");
