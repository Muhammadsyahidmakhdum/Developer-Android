package id.ac.poliban.mi.e020319046.notifymechallange;
...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String ACTION_UPDATE_NOTIFICATION =
            "id.ac.poliban.mi.e020319046.notifymechallange.ACTION_UPDATE_NOTIFICATION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("NotifyMeChallangeSyahid");
