package id.ac.poliban.mi.e020319046.droidcafewithsettings;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String EXTRA_MESSAGE =
            "id.ac.poliban.mi.e020319046.droidcafewithsettings.extra.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar()!=null)getSupportActionBar().setTitle("DroidCafeWithSettingSyahid");
