package id.ac.poliban.mi.e020319046.recyclerviewhomework;
...
public class RecipeListAdapter extends RecyclerView.Adapter<RecipeListAdapter.RecipeViewHolder> {
    ...
    public final static String EXTRA_NAME = "id.ac.poliban.mi.e020319046.recyclerviewhomework.EXTRA.NAME";
